...
describe('ResponsiveNavShell', () => {
  it('shows the tab bar (no sidebar) on phone width and keeps content', () => {
    setWidth('phone');
    const onSelect = jest.fn();
    const { getByTestId, queryByTestId } = render(
      <Shell activeId="Home" onSelect={onSelect} />,
    );
    expect(getByTestId('cupertino-tabbar')).toBeTruthy();
  ...
  it('switches tab bar -> sidebar live when width crosses into tablet range', () => {
    setWidth('phone');
    const onSelect = jest.fn();
    const { queryByTestId } = render(
      <Shell activeId="Home" onSelect={onSelect} />,
    );
    expect(queryByTestId('cupertino-tabbar')).toBeTruthy();
    expect(queryByTestId('cupertino-sidebar')).toBeNull();
