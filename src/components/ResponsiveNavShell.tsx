...
export function ResponsiveNavShell({
  ...
  // Compact width (phone): the launcher dock (`launcher-dock`) IS the
  // navigation, so there is no bottom tab bar. Reintroducing one here was the
  // regression removed in #651-A (commit 3206242 eliminated the tabs). The
  // content fills the shell on its own.
  return (
