...
//
// Issue #280 created WalletScreen with an in-screen add sheet. Issue #281
// replaced that inline flow with navigation to a dedicated PassEditScreen for
// creating passes. Issue #284 added a "Scan" nav-bar action that opens
// PassScanScreen. Issue #746 added PassDetailScreen (view/delete) reached by
// tapping an existing row. WalletScreen now requires a `navigation` prop and
// only dispatches navigate() calls; it owns no form state of its own.
