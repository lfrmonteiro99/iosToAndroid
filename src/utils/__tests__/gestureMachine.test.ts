...
// #442: TodayView was registered in RootStackParamList and rendered in
...
// for was never wired up. This is the pure commit predicate for the
// right-swipe-on-first-page gesture that now reaches it.
